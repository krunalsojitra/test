                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody id="resulttable">
                      ...
                      <?php 
								...
								?>
                      <tr>
                        <td class="selection"><input type="checkbox" class="checkbox" name="sendmaiID" value="<?php echo $result['card_id'];?>"></td>
                        <td><?php echo $result['card_name'];?></td>
                        <td><?php echo $result['card_email'];?></td>
                        <td class="Cardimg">
                        <?php if(isset($result['card_image'])){?>
                        	<img height="150px"  src="<?php echo URL;?>public/upload/image/<?php echo $result['card_image'];?>" />
                        <?php }else{?>
                        	<img height="150px"  src="<?php echo URL;?>public/img/noimg.png" />
                        <?php }?>
                        </td>
                      </tr>
                      <?php }?>
